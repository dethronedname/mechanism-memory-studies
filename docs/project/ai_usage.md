...
This statement does not assign an unverified model/version to every historical contribution. AI tools are not entered as independent human researchers in citation metadata. Referenced third-party works retain their own authorship.
