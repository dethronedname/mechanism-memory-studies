...
The imported baseline source describes its implementations as local adaptations and explicitly says that GNS source was not copied. Curation found no vendored upstream implementation in the imported files. The owner has confirmed sole ownership of the original project material and authorized the [repository licenses](../LICENSING.md); this does not relicense the cited works or external dependencies. No weights, figures or code were downloaded from the cited works.
