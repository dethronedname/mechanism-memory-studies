# C1 public source snapshot

Source authority: confirm_gpu_01_lite.zip. File identities and transformations: [catalog/source_imports.json](../../catalog/source_imports.json).
...
From the repository root, run: python scripts/verify_reference.py --study c1. This standard-library check does not train or load weights. Limited CPU checks and unexecuted GPU entry points: [reproduction](../../docs/reproduction.md).
