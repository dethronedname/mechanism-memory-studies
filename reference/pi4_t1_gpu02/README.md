# T1 public source snapshot

Source authority: time_gpu_02_lite.zip. File identities and transformations: [SOURCE_IMPORT_MANIFEST.json](../../SOURCE_IMPORT_MANIFEST.json).
...
From the repository root, run: python scripts/verify_reference.py --study t1. This standard-library check does not train or load weights. Limited CPU checks and unexecuted GPU entry points: [reproduction](../../docs/reproduction.md).
